...
//
//  shader example from:
//  https://github.com/SonarSystems/Modern-OpenGL-Tutorials/blob/master/%5BADVANCED%20OPENGL%5D/%5B17%5D%20Cubemap:Skybox/Shader.h
...
public:
    ...
    Shader( const GLchar *vertexPath, const GLchar *fragmentPath )
    {
        ...
        if (!success)
        {
            ...
            std::cout << "ERROR::SHADER::PROGRAM::LINKING_FAILED[E]\n" << infoLog << std::endl;
        }
